...
export class PaginationQuery {
  @ApiPropertyOptional({ description: 'Ограничение количества возвращаемых элементов', minimum: 1, maximum: DefaultPagination.Limit, default: DefaultPagination.Limit })
  ...
  @ApiPropertyOptional({ description: 'Страница пагинации', minimum: 1, default: DefaultPagination.Page })
