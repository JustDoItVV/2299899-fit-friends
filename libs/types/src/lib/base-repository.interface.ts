import { BaseEntity, DefaultPojoType, EntityIdType } from './base-entity.interface';

export interface BaseRepository<EntityType extends BaseEntity<EntityIdType, PojoType>, PojoType = DefaultPojoType> {
